...
>
> **Next action: Stripe support** — only Stripe can reconcile this. Ask them to unlock / force-complete **"Confirm your integration choices"** (the Connect platform profile) for `acct_1Tz4YOReBKCY8Yl1`, explaining that *Activate payments* will not tick because the account is already activated.
>
